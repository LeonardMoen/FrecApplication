 ...
 * @author L19mo
 */
public class Frec extends JPanel implements KeyListener {
// Make all objects static
	static Board board;
	static Pacman pacman, pacman2;
        static BufferedImage frosh, tam;
	static int frames = 0;
	static int level = 1;
	static int option = 0;
	...
	static void drawMenu(Graphics g){
            //g.drawImage(Frec.tam, 50, 50, 20, 20, null);
		...
		g.drawString("Leonard Moen", 421, 237);
	}
